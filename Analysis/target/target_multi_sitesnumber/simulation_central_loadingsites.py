...
face, back, clife, cof, life, slife, birth, targetsnum, deltactcf, pause, sep, site, monomer, replica, steps, vel = params
base_loading = 0.0001
paramdict_CTCF={
...
density_multiplier = 1 + (((targetsnum*(birth-base_loading))/base_loading)/total_sites)
paramdict_CTCF['LEF_separation'] /= density_multiplier
paramdict_CTCF['LEF_separation'] = int(paramdict_CTCF['LEF_separation'])
...
Trajn = 4310000 # trajectory length in monomer 
