...
face, back, clife, cof, life, slife, birth, deltacoh, deltactcf, pause, sep, site, monomer, replica, steps, vel = params
fixedclife = 17.0
fixedcof = 17.0
paramdict_CTCF={
            'CTCF_facestall':[face, face],
            'CTCF_backstall':[0, 0],
            'CTCF_lifetime':[fixedclife, clife],
            'CTCF_offtime':[fixedcof, cof],
            'LEF_lifetime':[life, life],
            'LEF_stalled_lifetime':[slife, slife],
            'LEF_birth':[birth, birth],
            'deltacoh' :deltacoh,
            'deltactcf':deltactcf,
...
# Let's make some strong and fixed CTCF regions
typedict = {'strong_CTCF':1, 'fixed_CTCF':0}
site_types[:3501+deltacoh+(deltactcf//2)] = typedict['strong_CTCF']
site_types[3501+deltacoh+(deltactcf//2):] = typedict['fixed_CTCF']
...
Trajn = 10000000 # trajectory length in monomer 
